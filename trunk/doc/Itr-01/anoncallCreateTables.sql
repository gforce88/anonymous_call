...
INSERT `partners` (
        ...
        VALUES (
          ...
          'You have been invited to call %1s using AnonCall.<br>Please click this link to call <a href="%2s">%2s</a>',
          '%1s accept your invitation',
          '%1s accept your invitation.<br>Please click this link to call <a href="%2s">%2s</a>',
          'Your invitation was declined by %1s',
          'Sorry,<br>%1s is not ready to speak with you yet.',
          'Your invitation was accepted by %1s',
          'Get your phone ready.<br>We will be connecting you with %1s momentarily',
          '%1s is not available',
          'Sorry,<br>%1s is not available to speak with you at this time.',
          'Please retry to checkout Paypal',
          'Oops.<br>Looks like something went wrong. Click below URL to retry to checkout Paypal:<br><a href="%2s">%2s</a>',
          'Thanks for using AnonCall',
          'Thanks for using AnonCall.<br>Call Duration: %2s<br>Billable Duration: %3s<br>Charge Amount: %4s %5s',
          'address1',
          'address2',
          'US');
INSERT `partners` (
