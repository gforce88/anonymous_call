...
cp -f /root/workspace/AnonCall/application/configs/ivr_Production.ini /root/workspace/AnonCall/application/configs/ivr.ini
rm -f /root/workspace/AnonCall/application/configs/sdk_config.ini
cp -f /root/workspace/AnonCall/application/configs/sdk_config_Production.ini /root/workspace/AnonCall/application/configs/sdk_config.ini
