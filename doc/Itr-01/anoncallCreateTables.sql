...
INSERT `partners` (
        ...
        VALUES (
          ...
          'You have been invited to call %1s using Tokumei number.<br>Please click this link to call <a href="%2s">%2s</a>',
...
INSERT `partners` (
        ...
        VALUES (
          ...
          'JpTest@email.com',
          '%1s邀请你拨打电话',
          '%1s邀请你拨打匿名电话。<br>请点此链接拨打电话<a href="%2s">%2s</a>',
          '%1s接受了你的邀请',
          '%1s接受了你的邀请。<br>请点此链接拨打电话<a href="%2s">%2s</a>',
          'declineEmailSubject',
          'declineEmailBody',
          'readyEmailSubject',
          'readyEmailBody',
