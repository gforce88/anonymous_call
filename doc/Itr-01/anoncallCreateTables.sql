...
CREATE TABLE `partners` (
  ...
  `inviteEmailContent`     text(65535)     NOT NULL                    COMMENT 'invite email body',
  `acceptEmailSubject`  varchar(256)    NOT NULL                    COMMENT 'accept email subject',
  `acceptEmailContent`     text(65535)     NOT NULL                    COMMENT 'accept email body',
  `declineEmailSubject` varchar(256)    NOT NULL                    COMMENT 'decline email subject',
  `declineEmailContent`    text(65535)     NOT NULL                    COMMENT 'decline email body',
  `readyEmailSubject`   varchar(256)    NOT NULL                    COMMENT 'ready email subject',
  `readyEmailContent`      text(65535)     NOT NULL                    COMMENT 'ready email body',
  `sorryEmailSubject`   varchar(256)    NOT NULL                    COMMENT 'sorry email subject',
  `sorryEmailContent`      text(65535)     NOT NULL                    COMMENT 'sorry email body',
  `retryEmailSubject`   varchar(256)    NOT NULL                    COMMENT 'retry email subject',
  `retryEmailContent`      text(65535)     NOT NULL                    COMMENT 'retry email body',
  `thanksEmailSubject`  varchar(256)    NOT NULL                    COMMENT 'subject line to use for thanks email',
  `thanksEmailContent`     text(65535)     NOT NULL                    COMMENT 'thanks email body',
