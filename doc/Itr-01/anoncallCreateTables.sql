...
INSERT `partners` (
        ...
        VALUES (
          ...
          '10123456789',
          'EnTest@email.com',
          'You have been invited to a call [fromName]',
          'You have been invited to call[fromName] using AnonCall.<br>Please click this link to continue <a href="[url]">[url]</a>',
          '[fromName] accept your invitation',
          '[fromName] accept your invitation.<br>Please click this link to continue <a href="[url]">[url]</a>',
          'Your invitation was declined by [fromName]',
          'Sorry,<br>[fromName] is not ready to speak with you yet.',
          'Your invitation was accepted by [fromName]',
          'Get your phone ready.<br>We will be connecting you with [fromName] momentarily',
          '[fromName] is not available',
          'Sorry,<br>[fromName] is not available to speak with you at this time.',
